...
public class CFGUtil
{
    ...
    public static void weakestPreCondition(Vector<Transition> path, Putinar putinar)  //NOTE: for C-Integer programs this is completely fine but for general T2 transition systems it might have problems
    {
